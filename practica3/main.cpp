...
//====================================================================================================================
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("Burbuja ha tardado: %f segundos (mejor caso)\n", tiempo);
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("Burbuja ha tardado: %f segundos (peor caso)\n", tiempo);
   //====================================================================================================================
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("QuickSort ha tardado: %f segundos (mejor caso)\n", tiempo);
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("QuickSort ha tardado: %f segundos (peor caso)\n", tiempo);
//====================================================================================================================
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("MergeSort ha tardado: %f segundos (mejor caso)\n", tiempo);
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("MergeSort ha tardado: %f segundos (peor caso)\n", tiempo);
//====================================================================================================================
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("Rango ha tardado: %f segundos (mejor caso)\n", tiempo);
    ...
    tiempo = ((float)clicksFin - clicksInicio) / CLOCKS_PER_SEC;
    printf("Rango ha tardado: %f segundos (peor caso)\n", tiempo);
